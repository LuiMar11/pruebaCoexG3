                        ...
                        <div class="card border-success"><br>
                            <form action="{{ route('credito.index') }}" method="GET">
                                ...
                                <div class="form-group row mx-2">
                                    ...
                                    <div class="col-sm-4">
                                        <input disabled type="number" class="form-control" id="num_pagare"
                                            name="num_pagare" value="{{ $credito->num_pagare }}">
                                    </div>
                                    <label class="col-sm-2 col-form-label"><b>Cuotas mensuales</b> </label>
                                    <div class="col-sm-3">
                                        <input disabled type="number" class="form-control" id="cuota_mensual"
                                ...
                                <div class="form-group row mx-2">
                                    ...
                                    <div class="col-sm-4">
                                        <input disabled type="number" class="form-control" id="monto_credito"
                                    ...
                                    <div class="col-sm-3">
                                        <input disabled type="text" class="form-control" id="cedula"
                                            name="cedula" value="{{ $credito->cliente }}">
                                    </div>
                                ...
                                <div class="form-group row mx-2">
                                    ...
                                    <div class="col-sm-4">
                                        <input disabled type="number" class="form-control" id="cuota_inicial"
                                ...
                                <div class="form-group row mx-2">
                                    ...
                                    <div class="col-sm-4">
                                        <input disabled class="form-control" type="date" name="fecha_credito"
                                ...
                                <div class="form-group row mx-2">
                                    ...
                                    <div class="col-sm-4">
                                        <input disabled class="form-control" type="date" name="fecha_credito"
                                        id="fecha_credito" value="{{ $credito->fecha_desembolso }}">
                                    </div>
                                    <label class="col-sm-2 col-form-label"><b>Observaciones</b></label>
                                    <div class="col-sm-3">
                                        <textarea disabled class="form-control" name="observaciones" id="observaciones" cols="60" rows="5" >{{ $credito->observaciones }}</textarea>
                                    </div>
                                </div><br>
                                <div class="form-group row mx-auto justify-content-center">
                                    <div class="col-sm-2">
                                        <button type="submit"
                                            class="btn btn-primary text-align-center">Volver</button>
                                    </div>
                                </div>
                                <br>
                            </form>
